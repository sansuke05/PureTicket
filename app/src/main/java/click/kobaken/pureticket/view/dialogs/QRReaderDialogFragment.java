...
import click.kobaken.pureticket.databinding.DialogQrReaderBinding;
...
public class QRReaderDialogFragment extends DialogFragment implements SurfaceHolder.Callback {
    public static final String TAG = QRReaderDialogFragment.class.getSimpleName();
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(activity)
                    ...
                    .setPositiveButton(android.R.string.ok, (di, i) -> dismiss())
                    .create();
        }
    }
    ...
    private class BarcodeTracker extends Tracker<Barcode> {
        ...
        public void onNewItem(final int id, final Barcode item) {
            Observable.just(item)
                    ...
                    .subscribe(barcode -> {
                        dismiss();
                        if (getParentFragment() instanceof OnQRReaderListener) {
                            OnQRReaderListener listener = (OnQRReaderListener) getParentFragment();
                            listener.setOnResult(item.rawValue);
                        }
                    });
        }
    }
